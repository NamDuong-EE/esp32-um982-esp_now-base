...
inline constexpr char MQTT_TOPIC_NAMESPACE[] = "aitogy";
inline constexpr char MQTT_TOPIC_STATUS_SUFFIX[] = "status";
inline constexpr char MQTT_TOPIC_COMMAND_SUFFIX[] = "command";
inline constexpr char MQTT_TOPIC_COMMAND_RESULT_SUFFIX[] = "command-result";
inline constexpr char MQTT_TOPIC_ROVERS_SUFFIX[] = "rovers";
